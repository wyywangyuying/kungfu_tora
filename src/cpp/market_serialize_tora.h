...
#ifndef KUNGFU_MARKET_SERIALIZE_TORA_H
#define KUNGFU_MARKET_SERIALIZE_TORA_H
...
inline void to_json(nlohmann::json &j, const CTORATstpRspInfoField &md) {
  /// 响应信息
  j["ErrorID"] = md.ErrorID;   ///错误代码
  j["ErrorMsg"] = md.ErrorMsg; ///错误信息
};
inline void to_json(nlohmann::json &j, const CTORATstpSpecificSecurityField &md) {
  /// 订阅行情
  j["ExchangeID"] = md.ExchangeID; ///交易所代码
  j["SecurityID"] = md.SecurityID; ///证券代码
};
